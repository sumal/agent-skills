---
name: kerala-minister-law-industries
description: Rapid Decision-Making advisor for Kerala's Minister of Law, Industries and Coir. Covers Law Department (legislation, litigation, legal opinions, Advocate General coordination), Industries (KSIDC, KINFRA, MSME, Startup Mission, Single Window Clearance), and traditional industries (Coir Board, KSCDC, handloom, khadi). Use for industrial policy decisions, factory/MSME licensing, legislation drafting, AG opinion calls, ease-of-doing-business reforms, and coir/traditional sector revival.
---

# Kerala Law, Industries & Coir Minister — Rapid Decision Skill

## Core Mandate & Top 3 KPIs
1. **Legal soundness of Government** — Quality of legislation, win-rate in litigation, AG concurrence turnaround, time to legal opinion.
2. **Investment & MSME growth** — Single Window approvals (K-SWIFT) within 30 days, MSME registrations, anchor investments via KSIDC/KINFRA, Kerala's EoDB ranking.
3. **Traditional sector livelihoods** — Coir, handloom, khadi, cashew artisans (lakhs of workers, mostly women); modernization without job loss.
...
- **State List core:** trade/commerce within State, industries subject to Union control, markets/fairs, land for industrial estates.
- **Concurrent List overlap:** factories, labour welfare, contracts, civil/criminal procedure, electricity, economic planning, boilers.
- **Union List watch:** industries declared under Union control, patents, foreign trade, SEZ/customs, corporate law, major ports/airports.
- **Rule:** industrial incentives are State-competent, but sector regulation may sit with Parliament; flag IDR Act/Union regulator conflicts.

## Rapid Decision Matrix (4-step)
1. **Legality** — Factories Act 1948, Industries (D&R) Act 1951, Kerala Industrial Single Window Clearance Act 1999/2018 amend., MSMED Act 2006, Coir Industry Act, Land Acquisition (RFCTLARR) 2013, Pollution Control Board NoCs.
2. **Exchequer** — Capital subsidy, interest subvention, KSIDC equity exposure, KIIFB co-financing, Coir Board CSS share.
3. **Sustainability** — KSPCB clearance, CRZ, zero-liquid-discharge mandate for new units, decarbonisation pathway, e-waste/plastic compliance.
4. **LSGI / Welfare** — LSGI consent for industrial estate land change of use, Kudumbashree convergence for women workers, SC/ST entrepreneur quota in MSME schemes.

## Stakeholder Consultation Map
- **Tier 0:** Chief Secretary, Law Secretary, Industries Principal Secretary, AG Kerala, Public Prosecutors
- **Tier 1:** District Panchayats, ULBs hosting industrial estates, KILA
- **Tier 2:** KSIDC, KINFRA, KBIP, Kerala Startup Mission, Coir Board (Centre+State), KSCDC, Handloom Dev Corp, Khadi Board, KSPCB
- **Tier 3 (Centre):** Ministry of MSME, DPIIT, Ministry of Law & Justice, CBIC (for SEZ/Customs), Coir Board (Cochin)
- **Tier 4:** CII/FICCI/ASSOCHAM Kerala, KCCI, Kerala State Small Industries Association, recognised trade unions in coir/cashew/factory sector, Bar Council of Kerala

## Top 3 Risks & Crisis SOP

### R1. Industrial Disputes / Strike at Anchor Plant
24h: Labour Commissioner § 12 ID Act conciliation; 72h: tripartite at Minister level; avoid ESMA unless essential service; settlement memo.

### R2. Adverse Court Order on Land/EIA (PIL stay on industrial project)
24h: AG + Law Secy on appeal/SLP; 72h: counter-affidavit, mitigation plan; consider phased project re-design.
